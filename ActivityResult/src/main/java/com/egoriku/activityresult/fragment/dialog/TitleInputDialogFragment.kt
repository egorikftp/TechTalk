...
import com.egoriku.activityresult.fragment.VALUE_TITLE
import com.google.android.material.dialog.MaterialAlertDialogBuilder

class TitleInputDialogFragment : DialogFragment() {
    ...
    private fun sendResult() {
        ...
        setFragmentResult(REQUEST_KEY, bundleOf(VALUE_TITLE to input))
    }
}