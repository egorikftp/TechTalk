package com.egoriku.blurhash.blurhash.encoder

import android.graphics.Bitmap
import com.egoriku.blurhash.blurhash.encoder.Utils.linearToSrgb
import com.egoriku.blurhash.blurhash.encoder.Utils.signedPow
import com.egoriku.blurhash.blurhash.encoder.Utils.srgbToLinear
import kotlin.math.*
...
object BlurHashEncoder {
    ...
    private fun encode(
        ...
        if (factors.size > 1) {
            ...
            Base83.encode(round(quantisedMaximumValue).toInt(), 1, hash, 1)
        } else {
            maximumValue = 1f
