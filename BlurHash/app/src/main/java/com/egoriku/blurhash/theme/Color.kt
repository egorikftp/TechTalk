package com.egoriku.blurhash.theme
...
val md_theme_dark_secondary = Color(0xFFe9c334)
val md_theme_dark_onSecondary = Color(0xFF3c2f00)
val md_theme_dark_error = Color(0xFFffb4a9)
val md_theme_dark_onError = Color(0xFF680003)
val md_theme_dark_background = Color(0xFF353232)
val md_theme_dark_onBackground = Color(0xFFecdfdf)
val md_theme_dark_surface = Color(0xFF353232)
